...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($row['password'] != $password) {
    ...
    if (isset($_POST['phone_number'])) {
      ...
      $query = "update users set phone_number = '$phone_number' where email = '$email'";
      mysqli_query($conn, $query);
    }
    if (isset($_POST['city'])) {
      $city = $_POST['city'];
      $query = "update users set city = '$city' where email = '$email'";
      mysqli_query($conn, $query);
    }
...
<body>
  ...
  <!-- update -->
  <section class="update_section container">
